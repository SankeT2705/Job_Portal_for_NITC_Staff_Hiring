...
const Home = React.memo(function Home() {
  ...
  const backgroundImageUrl = isDarkMode ? "/images/DarkThemeNitc.png" : "/images/NitGib2.png";
  ...
  return (
    ...
    <div
      className={`d-flex flex-column min-vh-100 ${isDarkMode ? "home-dark" : "home-light"}`}
    ...
    >
      ...
      >
        <div className="container py-5 position-relative">
          ...
          <div className="lead position-relative mb-4 mx-auto" style={{ maxWidth: "760px" }}>
      ...
      {/* Features Section */}
      <section className="py-5 position-relative" style={{ backgroundColor: "transparent" }}>
        <div className={`section-surface ${isDarkMode ? "section-surface--dark" : "section-surface--light"}`}>
